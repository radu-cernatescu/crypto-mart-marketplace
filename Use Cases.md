...
| 3   | Clicks Pay                         | For each order, the Buyer can select which crypto wallet (BTC, BHC, DOGE) to debit from, if and only if, the Seller allows payment of multiple cryptos, otherwise Buyer is forced to debit whatever Seller prefers (A4). Sellers are encouraged to accept more cryptos for more potential customers. |
| 4   | Clicks Place Order                 | Order confirmation page appears (A2).                                                                                                                                                                                                                                                                |
